...
import Techpack1 from '../../../assets/Design/DesignHero.jpeg'
...
function About() {
  return (
    <section className="flex flex-col self-center my-6 md:my-16 text-black w-[90vw]">
      ...
      Design & Tech Pack Creation is the process of developing a detailed blueprint for manufacturing a product, typically in the fashion and apparel industry.
      </p>
