...
import Techpack1 from "../../../assets/Photography/photography1.jpeg"
...
function About() {
  return (
    <section className="flex flex-col self-center my-6 md:my-16 text-black w-[90vw]">
      ...
      Photography is the art and process of capturing images using a camera. It involves recording light, either digitally or on film, to create visual representations of moments, people, products, landscapes, and more.
      </p>
