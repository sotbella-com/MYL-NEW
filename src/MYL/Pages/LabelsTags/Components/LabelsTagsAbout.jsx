...
import Techpack1 from '../../../assets/LabelsTags/labeltags1.jpeg'
...
function About() {
  return (
    <section className="flex flex-col self-center my-6 md:my-16 text-black w-[90vw]">
      ...
      Labels and tags are essential branding and informational elements used in fashion, retail, and manufacturing to provide details about a product. They serve as identification tools, helping consumers understand a product’s brand, material, care instructions, and other important details.
      </p>
