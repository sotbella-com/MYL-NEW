...
import Techpack1 from '../../../assets/Packaging/packaging1.webp'
...
function About() {
  return (
    <section className="flex flex-col self-center my-6 md:my-16 text-black w-[90vw]">
      ...
      Packaging refers to the process of enclosing, protecting, and presenting a product for storage, transportation, and sale. It plays a vital role in branding, safety, and customer experience.
      </p>
