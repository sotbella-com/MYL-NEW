...
function FAQ() {
  ...
  return (
    <div id="faq" className="flex flex-col justify-center bg-white shadow-[0px_4px_200px_rgba(232,249,247,0.2)]">
      <div className="flex flex-col w-[90vw] mx-auto my-6 md:my-16">
        {/* Header Section */}
        <div className="flex flex-col text-base leading-tight text-black whitespace-nowrap">
          ...
          <div className="flex flex-wrap gap-5 md:gap-10 justify-between items-center mt-4">
        ...
        <div className="flex flex-col mt-4 md:mt-10">
          ...
          <div className="flex flex-col self-center gap-5 mt-10 w-[80%]">
            ...
            <div className="flex flex-col justify-center mt-4">
              <button
                className="flex gap-2.5 justify-center items-center self-center px-10 py-3 mt-4 md:mt-10 text-base leading-tight rounded-xl border-2 border-solid border-zinc-400 text-zinc-900 hover:bg-zinc-900 hover:text-white hover:border-zinc-900 transition-all duration-300"
