...
const PricingCard = ({
  ...
  // Convert prices from USD using exchange rates
  ...
  return (
    ...
    >
      <div className="flex flex-col w-full">
        <h3
          className={`h-12 lg:h-24 xl:h-20 text-lg lg:text-2xl font-bold transition-colors duration-300 ${
      ...
      <div className="flex flex-col mt-5 w-full">
        <div className="flex items-center gap-2">
          {roundedDiscountedPrice && roundedDiscountedPrice < displayPrice ? (
            <>
              <span
                className={`text-2xl lg:text-3xl 2xl:text-4xl font-semibold transition-colors duration-300 ${
                  isPopular
                    ? "text-white"
              ...
              <span
                className={`text-xl lg:text-2xl 2xl:text-3xl font-medium line-through transition-colors duration-300 ${
                  isPopular
                    ? "text-white/50"
