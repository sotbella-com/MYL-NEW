...
//         <h2 className="font-Plus Jakarta Sans text-4xl lg:text-6xl font-semibold">
...
//                   {step.title}
//                 </h3>
//                 <p className="mt-1 text-sm md:text-base text-gray-800 text-opacity-70">
//                   {step.description}
//                 </p>
//               </div>
//             </div>
...
//                   />
//                 </div>
//                 <p className="mt-4 text-sm lg:text-base text-gray-800 text-opacity-70">
//                   {section.content}
//                 </p>
//               </div>
//             ))}
...
function Process() {
  ...
  return (
    ...
    >
      <div className="shrink-0 border-2 border-black border-solid w-full" />
      <div className="flex justify-between text-base leading-tight text-black whitespace-nowrap mt-4 w-full">
        <div className="flex-1">Solutions</div>
        <div className="flex-1 text-right">02</div>
      </div>
      ...
      <div className="flex flex-col items-center lg:flex-row justify-between mt-6 space-y-2 lg:space-y-16 ">
        {/* Left Section: Timeline */}
        <div className="flex flex-col lg:w-[55%] relative">
          {processSteps.map((step, index) => (
            <div
