...
import Techpack1 from '../../../assets/Sourcing/sourcing1.png'
...
function About() {
  return (
    <section className="flex flex-col self-center my-6 md:my-16 text-black w-[90vw]">
      ...
      Sourcing is the process of finding, evaluating, and securing suppliers, materials, or products needed for production. It is a critical step in manufacturing, retail, and business operations, ensuring that high-quality resources are obtained at the best price and efficiency.
      </p>
