...
import Techpack1 from '../../../assets/Production/production1.jpg'
...
function About() {
  return (
    <section className="flex flex-col self-center my-6 md:my-16 text-black w-[90vw]">
      ...
      Production is the process of bringing a fashion design to life, ensuring that every piece meets the highest standards of fit, fabric, and finish. It involves multiple specialized stages, where attention to detail ensures the final product aligns with your brand vision. 
      </p>
