...
import techpack from '../../../assets/Enterprice/techpackfashion.jpg'
  ...
  return (
    <section className="flex flex-col md:flex-row items-center justify-between w-[90vw] mx-auto py-6 md:py-16 bg-zinc-50">
      ...
      <div className="flex flex-col text-black w-full md:w-[55%] lg:w-[50%] max-md:text-center">
        ...
        Comprehensive Tech Pack Solutions for Seamless Garment Production 
        </h1>
        <p className="mt-4 md:mt-6 font-semibold text-lg md:text-xl text-gray-550 leading-7 md:leading-8">
        The journey of Make Your Label is deeply rooted in the legacy of precision and innovation. Our expertise ensures that every design is transformed into a production-ready blueprint, helping brands create high-quality, perfectly tailored garments with unmatched efficiency. 
        </p>
